...
<body>
								...
								<form id="demo-form2" class="form-horizontal form-label-left" action="ModifierCompte" method="post">
                                        ...
                                        <div class="form-group pwd_alert" hidden="hidden">
                                            <label class="control-label col-md-4 col-sm-4"></label>
                                            <div class="alert alert-danger alert_small col-md-4 col-sm-4">
                                        ...
                                        <input type="password" name="compteType" value="assistant" hidden="hidden">
